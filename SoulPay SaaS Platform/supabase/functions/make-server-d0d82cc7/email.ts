...
<table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
  ...
  <tr>
    <td style="padding:28px 40px;">
      ...
      <div style="text-align:center;margin-top:24px;">
        <a href="https://app.soulpay.kr/system/admin/partners" target="_blank" style="display:inline-block;background:#4f46e5;color:#ffffff;font-size:14px;font-weight:700;padding:12px 28px;border-radius:8px;text-decoration:none;">🔍 관리자 페이지에서 심사하기</a>
      </div>
    </td>
  </tr>
  <tr>
