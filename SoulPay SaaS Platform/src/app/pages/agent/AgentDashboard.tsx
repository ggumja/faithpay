  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        const sessionRaw = sessionStorage.getItem('soulpay_partner_session') || sessionStorage.getItem('faithpay_partner_session');
        if (!sessionRaw) {
    ...
    <div className={S.shell}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <main className="flex-1 overflow-y-auto">
          ...
          {section === 'commissions' && (
            <PartnerCommissionsSection commissions={commissions} isAgency={false} partner={partner} myTenants={myTenants} />
          )}
          {section === 'myinfo' && (
