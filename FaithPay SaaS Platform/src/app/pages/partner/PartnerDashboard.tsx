...
import {
  ...
  RefreshCw, BadgePercent, Percent, Landmark, Phone, Mail, ArrowLeft, CheckCircle2, Trophy,
} from 'lucide-react';
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          {section === 'agents' && isAgency && (
            selectedAgent ? (
              /* ── 1. 영업자 상세 페이지 (Sales Agent Detail View) ── */
              ...
              /* ── 2. 영업자 목록 및 서브 탭 뷰 (Sales Agents View with Sub-tabs) ── */
